--
-- WhiteCollarBlogs database schema.
--
-- Generated from the Payload collections in src/. Use it to bootstrap an empty
-- database (Neon, or any other Postgres) in one command:
--
--   psql "postgresql://...-pooler...neon.tech/neondb?sslmode=require" -f scripts/schema.sql
--
-- It creates tables only, no data. Pipeline stages are seeded by the app on
-- first use, and the first admin is created through the CMS itself.
--
-- To regenerate after changing a collection: point DATABASE_URI at a scratch
...
CREATE TYPE public.enum_authors_department AS ENUM (
    'engineering',
    'sales',
    'hr-ops',
    'marketing',
...
--
-- Name: enum_pipeline_stages_key; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.enum_pipeline_stages_key AS ENUM (
    'draft',
    'review',
    'approved',
    'scheduled',
...
CREATE TABLE public.authors (
    ...
    role character varying DEFAULT 'Technical Recruiter'::character varying NOT NULL,
    department public.enum_authors_department DEFAULT 'hr-ops'::public.enum_authors_department NOT NULL,
...
CREATE TABLE public.pipeline_stages (
    id integer NOT NULL,
    name character varying NOT NULL,
    key public.enum_pipeline_stages_key NOT NULL,
    color character varying DEFAULT '#64748b'::character varying NOT NULL,
    updated_at timestamp(3) with time zone DEFAULT now() NOT NULL,
    created_at timestamp(3) with time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE public.posts (
    ...
    read_time character varying DEFAULT '5 min read'::character varying,
    target_role character varying,
    views numeric DEFAULT 0,
    likes numeric DEFAULT 0,
    site character varying DEFAULT 'wcb'::character varying,
    external_status character varying,
    external_message character varying,
    external_url character varying,
    last_dispatched_at timestamp(3) with time zone,
    updated_at timestamp(3) with time zone DEFAULT now() NOT NULL,
    created_at timestamp(3) with time zone DEFAULT now() NOT NULL
);
...
--
-- Name: payload_locked_documents_rels_pipeline_stages_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX payload_locked_documents_rels_pipeline_stages_id_idx ON public.payload_locked_documents_rels USING btree (pipeline_stages_id);
...
--
-- Name: pipeline_stages_created_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX pipeline_stages_created_at_idx ON public.pipeline_stages USING btree (created_at);


--
-- Name: pipeline_stages_key_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX pipeline_stages_key_idx ON public.pipeline_stages USING btree (key);


--
-- Name: pipeline_stages_updated_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX pipeline_stages_updated_at_idx ON public.pipeline_stages USING btree (updated_at);
...
--
-- Name: posts_site_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX posts_site_idx ON public.posts USING btree (site);
...
--
-- Name: posts_stage_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX posts_stage_idx ON public.posts USING btree (stage_id);
...
--
-- Name: payload_locked_documents_rels payload_locked_documents_rels_pipeline_stages_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payload_locked_documents_rels
    ADD CONSTRAINT payload_locked_documents_rels_pipeline_stages_fk FOREIGN KEY (pipeline_stages_id) REFERENCES public.pipeline_stages(id) ON DELETE CASCADE;
...
--
-- Name: posts posts_author_id_authors_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.posts
    ADD CONSTRAINT posts_author_id_authors_id_fk FOREIGN KEY (author_id) REFERENCES public.authors(id) ON DELETE SET NULL;
...
--
-- Name: posts posts_stage_id_pipeline_stages_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.posts
    ADD CONSTRAINT posts_stage_id_pipeline_stages_id_fk FOREIGN KEY (stage_id) REFERENCES public.pipeline_stages(id) ON DELETE SET NULL;
